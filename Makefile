...
aap_demo:
	...
	packer build -var-file variables/rhel_9_aap_demo.pkrvars.hcl builds/linux/rhel/9

rhel_9_aap_job:
	packer init -var-file variables/rhel_9_aap_job.pkrvars.hcl builds/linux/rhel/9
	packer build -var-file variables/rhel_9_aap_job.pkrvars.hcl builds/linux/rhel/9

rhel_9_aap_workflow:
	packer init -var-file variables/rhel_9_aap_workflow.pkrvars.hcl builds/linux/rhel/9
	packer build -var-file variables/rhel_9_aap_workflow.pkrvars.hcl builds/linux/rhel/9