rhel9_base:
	packer init -var-file variables/rhel9_bas.pkrvars.hcl builds/linux/rhel/9
	packer build -var-file variables/rhel9_bas.pkrvars.hcl -var-file variables/common.pkrvars.hcl builds/linux/rhel/9
